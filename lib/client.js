window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		.dsstat-color-reset:hover:not(:disabled) { background: var(--dsw-alias-interactive-bg-hover); }
		.dsstat-color-reset:disabled { opacity: 0.45; cursor: default; }
